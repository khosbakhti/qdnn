...
void arm_cfft_q31(
  ...
  /**
   * @brief Instance structure for the float Precision Floating-point CFFT/CIFFT function.
   */
  typedef struct
  {
          uint16_t fftLen;                   /**< length of the FFT. */
  ...
  /**
   * @brief Instance structure for the float Precision Floating-point RFFT/RIFFT function.
   */
typedef struct
  {
