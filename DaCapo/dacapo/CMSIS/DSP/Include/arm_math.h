...
/**
   ...
   * - arm_cortexM7lfdp_math.lib (Cortex-M7, Little endian, float Precision Floating Point Unit)
   * - arm_cortexM7bfdp_math.lib (Cortex-M7, Big endian, float Precision Floating Point Unit)
