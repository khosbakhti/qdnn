...
#define FPU_MVFR0_float_precision_Pos      8U                                            /*!< MVFR0: float-precision bits Position */
...
/**
  ...
  \returns
   ...
   - \b  2: float + Single precision FPU
 */
__STATIC_INLINE uint32_t SCB_GetFPUType(void)
{
  ...
  mvfr0 = SCB->MVFR0;
  if      ((mvfr0 & (FPU_MVFR0_Single_precision_Msk | FPU_MVFR0_float_precision_Msk)) == 0x220U)
  {
    return 2U;           /* float + Single precision FPU */
  }
  else if ((mvfr0 & (FPU_MVFR0_Single_precision_Msk | FPU_MVFR0_float_precision_Msk)) == 0x020U)
  {
